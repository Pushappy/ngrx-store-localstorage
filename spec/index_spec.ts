...
describe('ngrxLocalStorage', () => {
    ...
    // NOTE: This can't really be tested since we can't create an actual feature reducer
    // that will initialize its initial state on the update-reducers action
    // it('should merge selectively saved state and rehydrated state (feature store)', () => {
    //     const initialState = {
    //         feature1: { slice11: false, slice12: [], slice13: {} },
    //     };
    ...
    //     const metaReducer = localStorageSync({
    //         keys: [{ feature1: ['slice11', 'slice12'] }],
    //         rehydrate: true,
    //         forFeature: true
    //     });

    //     const action = { type: UPDATE_ACTION, features: [ 'feature1' ] };
